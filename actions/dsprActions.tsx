...
export const getDSPROrderHistory = (dsprId, beginDayTimestamp, endDayTimestamp, orderStatus) => (
  dispatch,
  getState
) => {
...
export const createDsprPromotionForProductCategory = (
  ...
  return dispatch(
    createPromotionForProductCategory(dsprId, productCategoryId, promotionalText, imageFile)
  );
};
...
export const hideActiveDsprPromotionForProductCategory = (productCategoryId: number) => (
  dispatch
) => {
