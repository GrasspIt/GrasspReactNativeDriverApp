...
const orderModifier = (oldOrderId: number, orderDetails: any[], newDriverId: number, couponCode?: string) => {
    return {
        [CALL_API]: {
            httpAction: 'POST',
...
export const modifyOrder = (oldOrderId: number, orderDetails: any[], newDriverId: number, couponCode?: string) => dispatch => {
